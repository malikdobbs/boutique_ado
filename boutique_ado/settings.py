...
ALLOWED_HOSTS = ['malikdobbs-boutique-ado.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    AWS_S3_OBJECT_PARAMETERS = {
        ...
        'CacheControl': 'max-age=9400000'
    }

    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'malikdobbs-boutique-ado'
    ...
    DEFFAULT_FILE_STORAGE = 'custom_storages.MediaStorage'
